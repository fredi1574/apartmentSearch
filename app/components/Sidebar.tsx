...
export function Sidebar() {
  ...
  const menuItems = [
    ...
    { href: "/kanban", label: "Board", icon: Briefcase },
            ...
            {menuItems.map((item, idx) => {
              ...
              return (
                ...
                >
                  <Link
                    href={item.href}
                    className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group ${isActive ? "bg-primary/5 text-primary" : "text-gray-500 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-800/50"
                      }`}
                  >
